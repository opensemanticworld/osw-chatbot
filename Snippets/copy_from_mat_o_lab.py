...
if __name__ == "__main__":
    cred_filepath_ = Path(__file__).parent / "osw_files" / "accounts.pwd.yaml"
    source = "mat-o-lab.open-semantic-lab.org"
    targets = ["demo.open-semantic-lab.org"]
    titles = [
        "Category:OSW136953ec4cbf49ef80e2343c0e1981c0",
        "File:OSW0be38ecedcf046feab7c13716072767e.jpg",
        "OSW0be38ecedcf046feab7c13716072767e.jpg",
    ]
