...
def modify_schema(schema):
    """makes jsonschema OpenAI conform, see
    https://platform.openai.com/docs/guides/structured-outputs/supported-schemas
    Interate over a JsonSchema recursively. add the key
    additionalProperties: false to every type object schema. for each object
    properties which is not required add the union type with null, e.g. type:
        [string, null]. finally, make all properties required.
    """
