...
from osw_chatbot.structured_output.util import data_url_to_text, modify_schema

# from jsonref import replace_refs


def get_llm_response_azure_openai(
    promt, schema_dict=None, data_dict=None, files=None, web_search=False
):
    org_promt = promt
    # Configuration
    ...
    if schema_dict is not None:
        ...
        if schema_dict["type"] != "object":
            schema_dict = {
                ...
                "properties": {"__dummy_root__": schema_dict},
            }
        response_format = {
            "type": "json_schema",
            "json_schema": {
